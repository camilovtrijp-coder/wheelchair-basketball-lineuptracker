...
**8.3a lokaal geïmplementeerd op `codex/pr-8.3a`; nog niet als PR geopend.**
...
| PR 8.3a — securitybaseline, App Check-monitoring en lokale diagnostiek | Lokaal geïmplementeerd; PR nog niet geopend |  | Dreigingsmodel + machineleesbare Rules-/gatewaymatrix; exacte parentdocument-shapes en geen client-hard-delete; opt-in App Check voor staging/productie zonder enforcement/debugprovider; begrensde lokale allowlistdiagnostiek met NL/EN-export. Volledige Firebase-suite, v2-unit/lint/build en gerichte emulator-browserprobe groen. |
