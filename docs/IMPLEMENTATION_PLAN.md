...
| Fase 7 — wedstrijdsync en migratie | Implementatie gestart; PR 7.1a en 7.1b voltooid, PR 7.1c in review, 7.2–7.4 nog niet gestart |  | Aanbevolen keten: voltooid fundament 5.3/5.4 → 7.1a-c → 5.5b-activatie/5.5c-praktijkpoort → 7.2a-c → 7.3a-c → 7.4a-c. Zie `docs/pr-7.1-plan.md` t/m `docs/pr-7.4-plan.md` |
