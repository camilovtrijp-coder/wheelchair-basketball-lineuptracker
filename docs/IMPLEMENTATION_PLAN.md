...
- v1-key (`lineup-tracker-v1`) blijft tijdens de compatibiliteitsperiode
  leesbaar: een nog actieve v1-wedstrijd wordt bij de eerste (lege) v2-load
  eenmalig geadopteerd in de actieve organisatie/teamcontext (zie
  domain/game/v1Migration.ts) — v1 was zelf single-team, dus dit gebeurt
  precies één keer, niet per team;
...
| Fase 6 — overige v1-flows | PR 6.1 en 6.2 voltooid; overige PR's niet gestart |  | Wedstrijdopzet (6.1, klaar), live (6.2, klaar), historie/export (6.3), stats (6.4), trends (6.5) en back-up (6.6) |
