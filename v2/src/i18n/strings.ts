...
const nl = {
  ...
  gameTrackingPlaceholder:
    'De wedstrijd is gestart. Het live wedstrijdscherm volgt in een latere update (PR 6.2).',
...
const en = {
  ...
  gameTrackingPlaceholder:
    'The game has started. The live game screen is coming in a later update (PR 6.2).',
